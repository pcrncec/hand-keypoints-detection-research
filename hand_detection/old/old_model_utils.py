from hand_detection.models.tiny_yolo import TinyYolo
from hand_detection.models.yolo_loss import YoloLoss
...
def get_prediction_model(anchors, max_boxes, num_classes, weights_path):
    model_with_loss = create_model(anchors, max_boxes, num_classes, show_full_summary=True)
